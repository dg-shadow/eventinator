...
for link in event_links:
    ...
    # Debugging: Print all <p> tags to see the raw content
    # This will help you identify which <p> tag contains the correct date/time
    print(f"Event URL: {event_url}")
    for p_tag in event_soup.find_all('p'):
        print(f"Content: {p_tag.get_text().strip()}")  # Print each <p> content
